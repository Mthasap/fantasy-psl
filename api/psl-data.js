...
function getFallbackData() {
  return {
    ...
    table: [
      { pos:1,  team:'Orlando Pirates',   abbr:'Pirates',     logo:LOGOS['Orlando Pirates'],   p:20, w:14, d:2, l:4,  pts:44 },
      { pos:2,  team:'Mamelodi Sundowns', abbr:'Sundowns',    logo:LOGOS['Mamelodi Sundowns'], p:20, w:13, d:5, l:2,  pts:44 },
      { pos:3,  team:'Sekhukhune United', abbr:'Sekhukhune',  logo:LOGOS['Sekhukhune United'], p:20, w:9,  d:5, l:6,  pts:32 },
      { pos:4,  team:'Durban City',       abbr:'Durban City', logo:LOGOS['Durban City'],       p:20, w:10, d:4, l:6,  pts:34 },
      { pos:5,  team:'AmaZulu FC',        abbr:'AmaZulu',     logo:LOGOS['AmaZulu FC'],        p:19, w:9,  d:3, l:7,  pts:30 },
      { pos:6,  team:'Kaizer Chiefs',     abbr:'Chiefs',      logo:LOGOS['Kaizer Chiefs'],     p:19, w:8,  d:6, l:5,  pts:30 },
      { pos:7,  team:'Polokwane City',    abbr:'Polokwane',   logo:LOGOS['Polokwane City'],    p:20, w:7,  d:7, l:6,  pts:28 },
      { pos:8,  team:'TS Galaxy',         abbr:'TS Galaxy',   logo:LOGOS['TS Galaxy'],         p:21, w:7,  d:3, l:11, pts:24 },
      { pos:9,  team:'Richards Bay',      abbr:'R. Bay',      logo:LOGOS['Richards Bay'],      p:20, w:5,  d:8, l:7,  pts:23 },
      { pos:10, team:'Stellenbosch FC',   abbr:'Stellenbosch',logo:LOGOS['Stellenbosch FC'],   p:20, w:6,  d:5, l:9,  pts:23 },
      { pos:11, team:'Siwelele FC',       abbr:'Siwelele',    logo:LOGOS['Siwelele FC'],       p:20, w:5,  d:7, l:8,  pts:22 },
      { pos:12, team:'Golden Arrows',     abbr:'Arrows',      logo:LOGOS['Golden Arrows'],     p:20, w:6,  d:3, l:11, pts:21 },
      { pos:13, team:'Chippa United',     abbr:'Chippa',      logo:LOGOS['Chippa United'],     p:19, w:4,  d:7, l:8,  pts:19 },
      { pos:14, team:'Orbit College FC',  abbr:'Orbit Col.',  logo:LOGOS['Orbit College FC'],  p:21, w:5,  d:3, l:13, pts:18 },
      { pos:15, team:'Marumo Gallants',   abbr:'Gallants',    logo:LOGOS['Marumo Gallants'],   p:21, w:3,  d:6, l:12, pts:15 },
